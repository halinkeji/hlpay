...
<template>
  <q-page class="full-width column no-wrap justify-start fixed">
    <div class="fixed-center full-width">
     ...
     <div class="btn-num-box-center text-h5 text-weight-bolder q-mt-lg text-positive">
      支付成功
    </div>
...
<style lang="scss">
  ...
  .btn-submit-box {
    ...
    background: radial-gradient(122.27% 198.92% at -22.27% -27.38%, #0070BA 0%, #1546A0 100%) /* warning: gradient uses a rotation that is not supported by CSS and may not behave as expected */;
