  ...
  <q-page class="full-width column no-wrap justify-start fixed">
    <div class="fixed-center full-width">
      <div class="btn-num-box-center ">
       <q-icon name="fa-solid fa-triangle-exclamation" color="negative" size="64px" />
      </div>
       <div class="btn-num-box-center text-h5 text-weight-bolder q-mt-lg text-negative">系统错误</div>
